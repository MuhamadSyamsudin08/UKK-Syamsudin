...
<input type="submit" style="margin-top:10px" class="btn btn-outline-dark my-2 my-sm-0" style="padding:8px" name="cari" value="Cari Data" />
    ...
    <table class="table1" align="center" width="100%">
		<tr>
            ...
            <th>Username</th>
            <th>Password</th>
            <th><a class="btn btn-dark" style="float:left;" href="cetak_user_masarakat.php" role="button"><i class="fa fa-print"></i> Cetak</a> </th>
		</tr>
<?php
$batas =5;
...
<input type="submit" class="btn btn-success" style="padding:8px" name="cari" value="Cek Periksa" /></td>
</form>
</td>
</tr>
<?php }}else{
