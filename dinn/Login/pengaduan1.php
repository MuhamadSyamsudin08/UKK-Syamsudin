    ...
    <header>
        <div class="header-area ">
            <div class="header-top_area d-none d-lg-block">
                <div class="container" style="background-image: url('img/banner/guru-picsay.jpg');">
                    <div class="row">
            ...
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2" style="background-image: url('img/banner/landscape.jpg');">
             ...
             <div class="slider_text ">
                                ...
                                <p style="color:white">Selamat datang di web Pengaduan Masyarakat Desa Pangauban<br>
                                    Silahkan adukan keluhan anda</p></center>
...
<td><?=$data ['tlp'] ?></td>
<td><a href="http://localhost/azrl/terupload/<?= $data['foto'];?>"><img src="terupload/<?= $data['foto']?>" height="55px"></a></td>
<td><?=$data ['status'] ?></td>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Muhamad Syamsudin</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
