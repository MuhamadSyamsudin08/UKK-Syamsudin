...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2021 at 03:56 PM
...
(29, 'masyarakat', '3217090910990867', 'kp. Sukamanah', '01/01');
...
('3217093104789033', 'masyarakat', 'kp. Sukamanah', '01/01', 'masyarakat', 'masyarakat', '081234567891');
...
(87, '2021-04-08 (20:05:36)', 'masyarakat', '3217093104789033', 'test', '0845820081374', 'download.jpg', 'Proses');
...
(1, 'admin', 'admin', 'admin', '081234567891', 'admin'),
(2, 'petugas', 'petugas', 'petugas', '081234567891', 'petugas');
...
--
ALTER TABLE `data_masyarakat`
  MODIFY `id_masarakat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
