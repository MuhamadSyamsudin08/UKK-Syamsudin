        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2" style="background-image: url('img/banner/landscape.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
             <div class="slider_text ">><h1 style="color:white">Admin/Petugas Web<br>
...
<td><a href="#"><img src="Login/terupload/<?php echo $data['foto'];?>" height="55px"></a></td>
...
<button class="btn btn-dark dropdown-toggle" type="button" id="dropdownMenuButton" style="width:auto" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-cogs" aria-hidden="true"></i></button>
  	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
		<a class="dropdown-item" href="tanggapan.php?id=<?php echo $data['id_pengaduan'] ?>">Tanggapi</a>
        <a class="dropdown-item" href="tanggapan_petugas.php?id=<?php echo $data['isi_laporan'] ?>">Lihat Tanggapan</a>
	</div>
</div>
</form></td>
</tr>
