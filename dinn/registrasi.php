        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2" style="background-image: url('img/banner/landscape.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
             <div class="slider_text "><h1 style="color:white"> Pengaduan Masyarakat<br></h1>
                                <p style="color:white">Selamat datang di web Pengaduan Masyarakat Desa Pangauban<br>
                                    Silahkan Registrasi.</p></p>
...
<form method="post">
<td><h7>NIK</h7></td><td><input type="text" name="nik" class="form_input2" required="required" placeholder="NIK"></td>
</tr>
<tr>
...
<tr>
<td><h7>NO TELEPON</h7></th><td><input type="text" name="tlp" class="form_input2" required="required"  placeholder="+62..."></td>
</tr>
<tr>
