...
if (isset($_POST['simpan'])){
	...
	if($tambah){
		...
		echo "<meta http-equiv='refresh' content='1;url=tanggapan.php'>";
		}
		}
?>
...
<td><h7>TANGGAL TANGGAPAN</h7></td><td><input type="text" name="tgl" class="form_input2" required value="<?php date_default_timezone_set('Asia/Jakarta'); echo date('Y-m-d (H:i:s)') ?>"></td>
</tr>
